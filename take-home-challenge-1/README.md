...
Take home challenges are a great way to show off your coding skills. Many times, you'll be asked to code something that you have not done before, or ot use a technology you have not had time to learn yet. It is a great opportunity to level up your skill level and learn more what is out there.

Regardless of the outcome, take home challenges are opportunities to broaden and refine your abilities.
...
Take home challenges can be very broad, from just doing CSS, do building an API, to a full stack app, to making a game, nearly anything is possible. You may or may not be able to choose the language you code in and may or may not have a choice about the tech stack (MERN, Ruby on Rails, Django etc.).
...
Don't plan or add extra features. It may be cool to add CSS animations to all the buttons, but if it is not asked for, do not do it.
...
1. Make your code pretty (go back and proofread your code and make sure you fix indentation , improve your comments, improve your variable names etc., use the same version of syntax (if you use `const`/`let`, don't sometimes use `var`, declare your functions in the same way (unless you have a specific reason not to) etc.))\*
...
1. Make it work (fix bugs, handle edge cases, handle errors)
...
**Bonus** - if it is an option, use tests/implement TDD. We have not yet covered it in class, but you should take some time to learn on your own. Especially if you know the company uses tests/TDD. You can look back at previous labs that had testing for examples.
